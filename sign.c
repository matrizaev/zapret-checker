...
char *SigningPerform (void *inData, size_t inputLength, size_t *outputLength, uint8_t *userPIN, size_t userPINLen, uint8_t *keyPairId, size_t keyPairIdLen)
{
	/************************************************************************
...
//		{ CKA_CERTIFICATE_CATEGORY, &tokenUserCertificate, sizeof(tokenUserCertificate)},	// Категория сертификата - пользовательский
	...
	*************************************************************************/
	result = Base64Encode (signature, signatureSize, outputLength);
	check (result != NULL, "Cannot base64 encode signature.");
error:
	/*************************************************************************
